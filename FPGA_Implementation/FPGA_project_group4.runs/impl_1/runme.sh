...
HD_PWD='C:/Users/Yarne/FPGA_PROJECT/FPGA_project_final_solution/FPGA_project_group4/FPGA_project_group4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Conv_Connection.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Conv_Connection.tcl -notrace
