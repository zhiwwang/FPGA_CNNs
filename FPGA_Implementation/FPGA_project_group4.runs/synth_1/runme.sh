...
HD_PWD='C:/Users/Yarne/FPGA_PROJECT/FPGA_project_final_solution/FPGA_project_group4/FPGA_project_group4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Conv_Connection.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Conv_Connection.tcl
